# From: https://github.com/CV4EcologySchool/ct_classifier/blob/master/ct_classifier/util.py
...
def init_seed(seed):
    ...
    if seed is not None:
        random.seed(seed)
        # we don't use NumPy in this code, but you would want to set its 
        # random number generator seed, too
